...
import { sectionGroups, similarSections } from "../../syntax/common/section-names";
import { SectionGroupMatcher } from "../../syntax/base/utils-sections";
...
import { ResolveValueEnumContext } from "./value-enum";
...
export class HintDataManagers {
    ...
    filterValueEnum(context: ResolveValueEnumContext) {
